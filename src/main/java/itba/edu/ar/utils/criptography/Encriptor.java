...
public class Encriptor {
    ...
    /*
        El default de count es 1, y el default de hash puede ser md5 o sha1. Para saber cuál es, hay que ver el archivo openssl.cnf
        todo: averiguar si lo mismo aplica para sha256
    */
